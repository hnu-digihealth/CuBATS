...
class TestRegistration(unittest.TestCase):
    ...
    def test_register_with_ref(
        ...
        mock_registrar.register.return_value = (MagicMock(), MagicMock(), MagicMock())
    ...
    def test_invalid_reference_slide(self):
        with patch("cubats.registration.os.path.exists") as mock_exists:
            ...
            mock_exists.side_effect = lambda path: path in ["/dummy/src", "/dummy/dst"]
